...
function App() {
  ...
  const handleAuthChange = (userName, authState) => {
    ...
    setShowLogin(false); // Ensure the login popup closes after authentication
  };
  ...
  return (
    <BrowserRouter>
      <div className='body bg-dark text-light'>
        {/* Conditionally render Login only if user is unauthenticated and showLogin is true */}
        {!authState === AuthState.Authenticated && showLogin && (
